...
pub fn day_4_main() {
    ...
    for line in cleanup_raw.lines() {
        ...
        if elf1.start <= elf2.start && elf1.finish >= elf2.finish || elf1.start >= elf2.start && elf1.finish <= elf2.finish {
            println!("Full found! elf1: {}-{}, elf2: {}-{}", elf1.start, elf1.finish, elf2.start, elf2.finish);
        ...
        if elf1.start <= elf2.start && elf1.finish >= elf2.start || elf1.start <= elf2.finish && elf1.finish >= elf2.finish || elf1.start >= elf2.start && elf1.finish <= elf2.finish {
            println!("Small overlap found! elf1: {}-{}, elf2: {}-{}", elf1.start, elf1.finish, elf2.start, elf2.finish);
