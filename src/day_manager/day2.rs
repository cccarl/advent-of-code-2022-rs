...
impl Game {
    ...
    fn result_if_match(&self) -> Result<i32, String> {
        ...
        // win
        if self.me == 'X' && self.opponent == 'C'
            || self.me == 'Y' && self.opponent == 'A'
            || self.me == 'Z' && self.opponent == 'B'
        {
            return Ok(6 + bonus);
        }
        // draw
        else if self.me == 'X' && self.opponent == 'A'
            || self.me == 'Y' && self.opponent == 'B'
            || self.me == 'Z' && self.opponent == 'C'
        {
            return Ok(3 + bonus);
        }
        // lose
        else if self.me == 'X' && self.opponent == 'B'
            || self.me == 'Y' && self.opponent == 'C'
            || self.me == 'Z' && self.opponent == 'A'
        {
            return Ok(0 + bonus);
        }
...
pub fn day_2_main() {
    ...
    println!(
        "The test result is: {}",
        test_game.result_if_match().unwrap()
    );
    ...
    println!(
        "The result v2 of the test is: {}",
        test_game.result_if_predicted_outcome().unwrap()
    );
